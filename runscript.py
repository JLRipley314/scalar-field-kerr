...
sim.nxs=   [127]#, 33] ## Number of radial pts on each domain 
...
sim.hyperboloidal=False ## Whether to evolve with hyperboloidal compactification or not 
...
sim.l_ang=  6 ## Initial data is a particular swal function.
sim.m_ang=  6 ## Must have m_ang >= 0.
